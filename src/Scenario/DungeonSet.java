...
public class DungeonSet {
    ...
    public DungeonSet(int varianza, int dunLvl, Characters player){
        ...
        dungeonSet[0] = new Dungeon(player, varianza, 5 + (1 * varianza), 300 + (50* varianza) + (50 * dunLvl),40 + (5* varianza) + (5 * dunLvl),
        ...
        dungeonSet[1] = new Dungeon(player, varianza, 5 + (1 * varianza), 300 + (50* varianza) + (50 * dunLvl),40 + (5* varianza) + (5 * dunLvl),
                40 + (5* varianza) + (5 * dunLvl), 30 + (5* varianza) + (5 * dunLvl), 30 + (5* varianza) + (5 * dunLvl), 30 + (5 * varianza) + (5 * dunLvl), 30 + (5 * varianza) + (5 * dunLvl), 30 + (5 * varianza) + (5 * dunLvl), 30 + (5 * varianza) + (5 * dunLvl));
        dungeonSet[2] = new Dungeon(player, varianza, 5 + (1 * varianza), 300 + (50* varianza) + (50 * dunLvl),40 + (5* varianza) + (5 * dunLvl),
                40 + (5* varianza) + (5 * dunLvl), 30 + (5* varianza) + (5 * dunLvl), 30 + (5* varianza) + (5 * dunLvl), 30 + (5 * varianza) + (5 * dunLvl), 30 + (5 * varianza) + (5 * dunLvl), 30 + (5 * varianza) + (5 * dunLvl), 30 + (5 * varianza) + (5 * dunLvl));
    }
